...
def load_data():
    ...
    Sn_delta_Baxter = pd.read_csv(csv_path, sep='\t')  # Passe den Separator an
    return Sn_delta_Baxter

def plot_Sn_StandardsBaxter(x, y, x_label, y_label, xerr, yerr, data_label):
    # Plotly Scatter-Plot
    fig = go.Figure()
...
def plot_all(Sn_delta, plot_selection):
    ...
    if plot_selection == "d124Sn/120Sn vs d116Sn/120Sn":
        return plot_Sn_StandardsBaxter(Sn_delta['d116Sn/120Sn'], Sn_delta['d124Sn/120Sn'], 
        ...
        return plot_Sn_StandardsBaxter(Sn_delta['d116Sn/120Sn'], Sn_delta['d122Sn/120Sn'], 
        ...
        return plot_Sn_StandardsBaxter(Sn_delta['d118Sn/120Sn'], Sn_delta['d124Sn/120Sn'], 
        ...
        return plot_Sn_StandardsBaxter(Sn_delta['d122Sn/120Sn'], Sn_delta['d124Sn/120Sn'], 
